...
export const metadata: Metadata = createPageMetadata({
  description:
    "Support maccn — macOS-inspired components for GPUI. Sponsor tiers, stargazers, and how to contribute.",
  path: ROUTES.SPONSOR,
  title: "Sponsor",
});
      ...
      <section className="container-wrapper relative">
        <div className="container max-w-2xl flex flex-col items-center gap-4 py-16 text-center md:py-20 lg:py-24">
          ...
          <p className="text-base text-muted-foreground text-balance">
            maccn is an open source library of macOS-inspired components for
            GPUI, built on top of gpui-base. Every component is free and
            that&apos;s not changing.
          </p>
